...
- [ ] Линейка «лента с резиновой обкладкой» — код написан, но исходный макет и прайс утеряны
...
- Линейка «лента с резиновой обкладкой» не запускается: в проекте нет исходного макета и файла `data/belt-sizes.xlsx`. Код линейки сохранён, готовые карточки прошлых прогонов лежат локально в `output/`.
