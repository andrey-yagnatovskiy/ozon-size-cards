...
TEMPLATE = os.path.join(BASE_DIR, 'layouts', 'polyurethane-sheets.png')
DATA_FILE = os.path.join(BASE_DIR, 'data', 'polyurethane-sheets-sizes.txt')
FONT_PATH = os.path.join(BASE_DIR, 'fonts', 'Montserrat-Black.ttf')
OUTPUT_DIR = os.path.join(BASE_DIR, 'output', 'polyurethane-sheets')

THICKNESS_CLEAR = (745, 1070, 855, 1112)
THICKNESS_BG = (252, 252, 252)
THICKNESS_DIGIT_LEFT = 749
THICKNESS_BASE_Y = 1108
THICKNESS_DIGIT_H = 33
THICKNESS_UNIT_H = 17
THICKNESS_UNIT_OFFSET = 0
THICKNESS_SPACING = 15
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate Ozon size cards for Rusbelt polyurethane sheet.'
    )
    ...
    for thickness in thicknesses:
        filename = f"{thickness}мм_полиуретан_листовой.png"
